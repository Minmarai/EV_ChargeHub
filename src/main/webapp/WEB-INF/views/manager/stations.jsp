...
<div class="manager-shell">
  ...
  <main class="manager-content">
    <section class="stations-head">
      ...
      <form method="post" action="${pageContext.request.contextPath}/station-manager/stations" style="display:inline;">
        <input type="hidden" name="action" value="createStation">
        <button type="submit" class="stations-request-btn">
      ...
      <table>
        ...
        <c:forEach var="s" items="${stations}">
          <tr
            ...
            <td>
              <div class="st-ports"><i class="fa-solid fa-bolt"></i> <strong>${availablePortsMap[s.stationId]}/${s.totalPorts}</strong></div>
            </td>
            <td>
