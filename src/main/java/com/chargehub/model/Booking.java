...
public class Booking {
    private int bookingId,userId,stationId,slotId; private String userName,stationName,vehicleNumber,bookingStatus,slotInfo,notes,paymentStatus; private Timestamp bookingDate; private BigDecimal amount;
